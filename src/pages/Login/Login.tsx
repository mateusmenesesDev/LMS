  ...
  return (
    <div className=''>
      ...
      <div className="mt-50 flex flex-col gap-5 items-center">
        ...
        <form action="POST" className="flex flex-col gap-5 w-screen items-center">
          ...
          <button type="submit" className="btn btn-primary btn-xs sm:btn-sm md:btn-md lg:btn-lg">Entrar</button>
        </form>
        <p>Você não tem uma conta? <a>Problema seu!</a></p>
      </div>
    </div>
  );
}
